...
const bookRecommendationPrompt = (userQuery) => {
  return `User query is "${userQuery}". If query not about books then reply - Please ask question about books. Else give 3 books as per query in following format based on training data:
...
<b>Similar Books</b><ol><li><b>List 2 book names within asterisk</b><p>Detailed reason for each</p></li></ol>
