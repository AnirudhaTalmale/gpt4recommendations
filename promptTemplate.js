...
const bookRecommendationPrompt = (userQuery) => {
  ...
  <b>Similar Books</b>
  <ol>
    <li><b>List 4 more books for given user query. Make sure to enclose "book title by author name" within asterisk.</b> <p>Explain the reason for listing each of them.</p></li>
  </ol>
