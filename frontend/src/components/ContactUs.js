    ...
    return (
        <div className="entire-contact-us-page">
            ...
            <div className="contact-container">
                ...
                <p>You can contact us via email at <a href="mailto:getbooksai@gmail.com">getbooksai@gmail.com</a>. We strive to respond to all inquiries as promptly as possible.</p>
